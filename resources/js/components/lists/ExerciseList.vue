<template>
  <div class="container mx-auto mb-20 flex px-0 md:px-8 mt-20">
    <aside class="w-1/4 hidden md:block">
      <h1 class="text-grey-darkest font-normal text-2xl mb-10 mx-2">Categories</h1>
      <ul class="list-reset">
        <li
    ...
    <div class="flex-1">
      <div class="px-4">
        ...
        <ul class="list-reset px-4 md:px-0">
          <li
            class="w-full py-4 md:hover:bg-grey-lighter rounded-lg px-4 flex items-center bg-white shadow-lg md:shadow-none mb-4 md:mb-0"

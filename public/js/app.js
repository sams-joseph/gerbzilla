  ...
  methods: {
    ...
    createExercise: function createExercise(e) {
      ...
      this.$http.post("".concat("http://gerbzilla.test/api", "/trainer/exercises"), {
        ...
        _this2.$emit("cancel-user-create");
      })["catch"](function (err) {
        _this2.$store.dispatch("add", {
          type: "error",
          message: err.message,
  ...
  methods: {
    ...
    createUser: function createUser(e) {
      ...
      this.$http.post("".concat("http://gerbzilla.test/api", "/trainer/users"), {
        ...
        _this.$emit("create-user-error", err);
        ...
        _c("div", { staticClass: "container mx-auto px-8 flex" }, [
          ...
          _vm.action
            ? _c(
                ...
                {
                  staticClass:
                    "inline-block flex items-center border-r border-l border-grey-light py-6"
                },
                [
                  _c(
                    "router-link",
                  ...
                  _c(
                    "button",
                    {
                      ...
                      on: {
                        click: function($event) {
                          $event.preventDefault()
                          return _vm.$emit("accept-delete-modal")
                        }
                      }
                    },
                    [_vm._v("Delete")]
        ...
        [
          ...
          _vm.authorized
            ? _c(
                "div",
                {
                  staticClass: "w-8 h-8 rounded-full cursor-pointer",
                  on: { click: _vm.openDrawer }
                },
                [
                  _c("img", {
...
var render = function() {
  ...
  return _vm.show
    ? _c(
        "div",
        { staticClass: "z-50 absolute bg-white px-8 pb-20 pin-l pin-t pin-r" },
        [
          _c(
            "div",
            {
              staticClass:
                "w-8 h-8 p-2 flex absolute pin-r pin-t border border-grey-dark justify-center items-center rounded-full mr-8 cursor-pointer",
              on: { click: _vm.closeWindow }
            },
            [
              _c(
          ...
          _c(
            "form",
            { staticClass: "max-w-md", on: { submit: _vm.createUser } },
            [
              _c("div", { staticClass: "mb-6" }, [
                _c(
                  "label",
                                ...
                                attrs: {
                                  ...
                                  to: {
                                    ...
                                    params: {
                                      ...
                                      workout_id: _vm.$route.params.workout_id,
                                      set_id: set.id
                                    }
                                  }
                                }
...
/* harmony import */ var _components_Loader__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./components/Loader */ "./resources/js/components/Loader.vue");
/* harmony import */ var _components_Construction__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./components/Construction */ "./resources/js/components/Construction.vue");
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component("loader", _components_Loader__WEBPACK_IMPORTED_MODULE_33__["default"]);
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component("construction", _components_Construction__WEBPACK_IMPORTED_MODULE_34__["default"]);
...
/* harmony import */ var _pages_Week__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/Week */ "./resources/js/pages/Week.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  routes: [{
    ...
    name: "user-workouts-week",
    component: _pages_Week__WEBPACK_IMPORTED_MODULE_5__["default"],
    meta: {
      requiresAuth: true
    }
  }, {
